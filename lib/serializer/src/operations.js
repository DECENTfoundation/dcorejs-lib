...
operation.st_operations = [transfer, account_create, account_update, asset_create, asset_issue, asset_publish_feed, set_publishing_right, update_monitored_asset_operation, asset_issue, miner_create, miner_update, witness_update_global_parameters, proposal_create, proposal_update, proposal_delete, withdraw_permission_create, withdraw_permission_update, withdraw_permission_claim, withdraw_permission_delete, vesting_balance_create, vesting_balance_withdraw, custom, assert, content_submit, request_to_buy, leave_rating_and_comment, ready_to_publish, proof_of_custody, deliver_keys, subscribe, subscribe_by_author, automatic_renewal_of_subscription, content_cancellation, asset_fund_pools_operation, asset_reserve_operation, asset_claim_fees_operation, update_user_issued_asset, disallow_automatic_renewal_of_subscription, return_escrow_submission, return_escrow_buying, pay_seeder, finish_buying, renewal_of_subscription, asset_options];
